...
- 迭代2：创建正确尺寸的地图，在可移动范围画上网格。用一个圆替代主角，实现摇杆，控制主角位移
- 迭代3：根据说明完善主角的动画表现，并且使主角骑马
- 迭代4：优化主角的移动速度，动画表现，比例
- 迭代5：主角装备三种武器，随机生成敌对士兵用以测试武器效果
- 迭代6：完善士兵ai，按照战斗地图逻辑出兵
- 迭代7：主角初始持剑，敌兵掉落金币，实装主角成长
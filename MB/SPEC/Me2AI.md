...
### 角色定义
- 比例：士兵的尺寸比主角小，这个比例同时应应用在武器，箭矢，马匹上
...
- 弓兵：于目标保持80%最大射程的距离，每8s刷新目标为最近敌人
- 骑兵：来回用骑枪冲锋最近的敌人。每15s刷新目标为最近敌人。骑兵AI使骑兵形成"冲过去→继续向前→继续冲"的循环
...
- 迭代10：完善骑兵AI
- 迭代11：按照战斗地图逻辑出兵，主角出生在己方建筑旁，士兵没有攻击目标时向对方建筑移动
